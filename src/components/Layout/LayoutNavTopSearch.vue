...
<template>
  <div class="h-7 w-full flex items-center justify-start rounded-lg bg-white ring ring-2 ring-purple-300 md:h-9">
    <input
    ...
    <div
      ...
      class="i-mdi:close-circle-outline mr-2 inline-block flex-shrink-0 text-gray-500"
      @click="searchContent = ''"
    />
    <button
